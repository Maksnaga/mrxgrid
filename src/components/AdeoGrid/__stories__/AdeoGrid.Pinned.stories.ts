...
- Les colonnes left-pinned sont rendues en premier dans la \`MrxGridRow\` ; les right-pinned en dernier. \`useGridState\` les expose en \`pinnedLeftColumns\`, \`pinnedRightColumns\`.
    ...
    template: `
      <div class="sb-mrx-shell">
        ...
        <div class="sb-mrx-frame">
          <MrxGrid :height="560" :columns="wide" :rows="rows" />
        </div>
      </div>
    `,
  }),
...
\`\`\`vue
<MrxGrid @column-menu-action="onMenuAction" />
\`\`\`
...
\`\`\`vue
<MrxGrid persist-key="my-grid-v1" :columns="cols" :rows="rows" />
\`\`\`
        `,
      },
    },
